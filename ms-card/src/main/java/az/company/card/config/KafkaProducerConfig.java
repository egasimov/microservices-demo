...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, CardOrderEntity> producerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, CardOrderEntity> orderKafkaTemplate() {
        var kafkaTemplate =
        ...
        kafkaTemplate.setProducerListener(new ProducerListener<>() {
            ...
            public void onSuccess(
                    ProducerRecord<String, CardOrderEntity> producerRecord,
            ...
            @Override
            public void onError(ProducerRecord<String, CardOrderEntity> producerRecord, Exception exception) {
    ...
    @Bean("kafka-trx-manager")
    KafkaTransactionManager<String, CardOrderEntity> transactionManager() {
